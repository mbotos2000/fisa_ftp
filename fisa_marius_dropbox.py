    ...
    with st.form('capitolul 4'):
      ...
      if submitted:
       ...
       # else:
        ...
        #new_row1 = df.values.tolist()
        

        # Format the date and time as a string (e.g., 'YYYY-MM-DD HH:MM')
        #datetime_string = current_datetime.strftime("%Y-%m-%d %H:%M")
        #new_row1=[clean_value(item) for item in new_row1[-1]]
        #new_row1[0]=file_name
        #new_row1[-1]=str(current_datetime)
        #st.write(new_row1)
       ...
       # creds = None
        ...
        #SAMPLE_SPREADSHEET_ID = '1ZItfwZxcqyr9u0Qghpya3MqIwy2TxXmO6JLiTmGrSbs'
        ...
        #request = sheet.values().append(
         ...
         #   insertDataOption='INSERT_ROWS',  # Adds the data as new rows
         #   body={
          #      'values': [new_row1]
         #   }
       # ).execute()
