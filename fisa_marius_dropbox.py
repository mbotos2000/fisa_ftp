...
if st.session_state['file']!=None or st.session_state['ut']:
  ...
  if st.session_state['cap2']=='2':
    with st.form('capitolul 2 si 3'):        
        ...
        st.write(doc_result.body[3][0][3])
        ...
        if submitted:
                ...
                st.session_state['M_2_4']=data1['an'].loc[(data1['specializare']==st.session_state['M_1_6']) & (data1['nume_disciplina']==st.session_state['M_2_1'])].values[0]
  ...
  if 'cap3' in st.session_state and st.session_state['cap3'] is not None:
    ...
    if remaining_time > 0:
        st.session_state['slide_37f'] = st.slider(
            '(f) Alte activități:',
            min_value=0,
            max_value=remaining_time,
            value=st.session_state['slide_37f'],
    ...
    if st.button('Treci la capitolul 4'):
        ...
        schimba_M_3_7_b(st.session_state['slide_37b'])
        schimba_M_3_7_c(st.session_state['slide_37c'])
        schimba_M_3_7_d(st.session_state['slide_37d'])
  ...
  if st.session_state['cap4']!=None:
    with st.form('capitolul 4'):
      ...
      if submitted:
        ...
        keys_to_merge=['M_8_2_14','M_2_2_1','M_8_2_1','M_3_3_p','M_8_1_14','M_8_2_9','M_8_1_o1','M_8_1_mp','M_8_1_mp1',
                       'M_8_1_1','M_3_3_s','M_7_2','data_dep','tip','dir_dep','M_8_2_5','M_3_7_e','M_2_1','M_10_2_c','M_8_1_12','M_1_2',
                       'M_10_6','M_9','M_2_3','M_10_3_a','M_1_1','M_8_1_13','M_3_4','M_3_3_l','M_8_1_5','M_8_2_6','M_3_5','M_4_2',
                       'da_cu','M_8_2_7','M_8_2_2','M_8_2_8','M_3_2','M_10_3_c','M_3_6_l','M_1_8','M_10_2_a','decan','M_8_1_10','Biblio_c','M_4_1',
